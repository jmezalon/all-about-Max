...
const ruby = document.getElementById("ruby-ul");

const rubyUl = document.getElementById("ruby");

function displayRubyUl() {
  rubyUl.style.display = "block";
}

function hideRubyUl() {
  rubyUl.style.display = "none";
}

ruby.addEventListener("click", displayRubyUl);

ruby.addEventListener("mouseleave", hideRubyUl);
